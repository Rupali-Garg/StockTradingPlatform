    ...
    <div className="container">
      ...
      >
        <div className="col-6 p-5">
          ...
          <p>
            Over 1+ crore clients place millions of orders everyday through our
        ...
        <div className="col-6 p-5">
          ...
          <p>
            ...
            , our fintech fund and, has invested in several fintech startups
            with the goal of growing the Indian capital markets.
          </p>
          <p>
            And yet, we are always up to something new everyday, Catch up on the
            latest updates on our blog or see what social media is saying about
            us.
          </p>
        </div>
      </div>
